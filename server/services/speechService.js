...
const { recognizeAudioViaHttp, recognizeAudioViaHttpSimple, checkASRServiceHealth } = require('../utils/phowhisperNodeClient');
...
const AUDIO_CONFIG = {
  ...
  minFrameLength: 16000 * 0.3, // Tối thiểu 0.3 giây âm thanh
