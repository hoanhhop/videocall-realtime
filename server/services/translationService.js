...
/**
 * Main Translation service client that connects to the Python Translation service (OPUS-MT)
 * This is the primary file used by all components needing translation functionality.
 * 
 * @see /server/services/translation_service/ for the Python implementation
 */
const { createLogger } = require('../utils/logger');
const { translateTextViaHttp, checkTranslationServiceHealth } = require('../utils/translationNodeClient');

const logger = createLogger('translation-service-main');
