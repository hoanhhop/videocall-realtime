...
/**
 * Main TTS service client that connects to the Python TTS service (XTTS-v2)
 * This is the primary file used by all components needing TTS functionality.
 * 
 * @see /server/services/tts_service/ for the Python implementation
 */
...
const ttsService = {
  ...
  advancedTextToSpeech: async (text, language = 'vi', options = {}) => {
    try {
      ...
      logger.error('Advanced TTS error:', error);
