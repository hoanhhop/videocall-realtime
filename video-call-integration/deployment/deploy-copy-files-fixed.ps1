...
ssh "$VMUser@$VMHost" "mkdir -p $VMBasePath/video-call-integration/server && mkdir -p $VMBasePath/video-call-integration/database && mkdir -p $VMBasePath/video-call-integration/client-components && mkdir -p $VMBasePath/video-call-integration/deployment && mkdir -p $VMBasePath/video-call-integration/nginx && mkdir -p $VMBasePath/video-call-integration/logs"
...
ssh "$VMUser@$VMHost" "chmod +x $VMBasePath/video-call-integration/deployment/*.sh && chmod +x $VMBasePath/video-call-integration/deployment/*.ps1 && find $VMBasePath/video-call-integration -type f -name '*.js' -exec chmod 644 {} \; && find $VMBasePath/video-call-integration -type f -name '*.json' -exec chmod 644 {} \;"
